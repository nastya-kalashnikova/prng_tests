...
char	generatorDir[NUMOFGENERATORS][32] = { "AlgorithmTesting", "LCG", "QCG1", "QCG2","CCG", "XOR", "MODEXP", "BBS", "MS", "G-SHA1", "AKalashnikovaChaCha20" , "AKalashnikovaGaloisRightLFSR", "AKalashnikovaGaloisLeftLFSR" };
